...
export class GoogleTTSService {
  ...
  private updateWAVHeader(buffer: Buffer): void {
  ...
  private splitParagraphBySentences(
    paragraph: string,
    maxBytes: number
  ): string[] {
  ...
  private forceSplitText(text: string, maxBytes: number): string[] {
  ...
  private ensureChunkSize(chunk: string, maxBytes: number): string[] {
